...
export const WeeklyMenuTabPanel: FC<WeeklyMenuTabPanelProps> = ({ className, id, menu }) => {
  ...
  const saladAndSoups = items.filter(item => item.type === 'soup' || item.type === 'salad');
        ...
        <div className="nybll-grid">
          <div className="nybll-grid__col-xs-12 nybll-grid__col-md-5 align-items-center">
            <picture>
              ...
              <img src={menu.image.png} alt={menu.name} />
            </picture>
          </div>
          <div className="nybll-grid__col-xs-12 nybll-grid__col-md-6 nybll-grid__col-md-start-7">
            <div>
              <WeeklyMenuTabPanelContentList dishes={entrees} heading="Entrees" />
              <WeeklyMenuTabPanelContentList dishes={saladAndSoups} heading="Salads and Soups" />
